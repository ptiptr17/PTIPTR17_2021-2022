...
<html lang="pt">
    ...
    <body>
        ...
        <div class="conteudo container row">
           ...
           <form action="../php/registerWarehouse.php" method="post">
            <h1>Registo</h1>
            <p>Para adicionar um armazém à sua conta siga os passos seguintes:</p>
            <hr>
            ...
            <div class="c">
            <label for="province_warehouse"><b>Provincia</b></label>
            <input type="text" name="province_warehouse" id="wprovince" />
            </div>
            ...
            <hr>
            <p>Ao criar uma conta está a concordar com <a href="#">Termos e Privacidade</a>.</p>
            <!-- <button type="submit" class="register">Register</button> -->
            <input type="submit" value="Submit" name="register_begin">
          </form>
